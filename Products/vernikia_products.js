const Products = [
	...
	*/
	...
	{
		name: "Quartz Primer",
		description: "Το QUARTZ PRIMER είναι ένα ειδικό αστάρι με βάση συνθετικές ρητίνες, αναμεμιγμένες με χαλαζία, οι οποίες έχουν πολύ υψηλή πρόσφυση σε όλες σχεδόν τις λείες επιφάνειες, στις οποίες, χωρίς προεργασία, είναι πρακτικά αδύνατον να γίνει επίστρωση άλλων υλικών. Η επιφάνεια στην οποία εφαρμόζεται αποκτά μια αδρή υφή, που προσομοιάζει με τσιμεντοκονία υψηλής αντοχής και μας επιτρέπει τη συγκόλληση πλακιδίων αλλά και την εφαρμογή επιχρισμάτων χωρίς προβλήματα στην πρόσφυση.",
		category: "Χαλαζιακό Αστάρι",
		amount: "1kg",
		image: "https://s6.imgcdn.dev/YCveXd.webp",
	},
	/*
	===========
	  Berling
	...
	*/
	{
		...
		category: "Χαλαζιακό Αστάρι",
		amount: "1L, 5L",
		image: "https://s6.imgcdn.dev/YndKQy.webp",
	},
	{
		name: "AP-103",
